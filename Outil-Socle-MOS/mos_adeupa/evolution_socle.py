...
class Evolution_mos(QDialog, Ui_interface_evolution):
    def __init__(self, parent=None):
        ...
        self.le_table_desti.editingFinished.connect(self.canStart)
        self.le_annee.editingFinished.connect(self.canStart)
        self.le_annee.editingFinished.connect(self.isYearGood)
