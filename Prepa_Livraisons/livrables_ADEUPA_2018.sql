...
--correction du champ tex
UPDATE production.mos_morlaix_2005_2015_2018_prod2_clean
Set section = tex, tex = section where tex in (Select distinct tex from cadastre_edigeo_29.geo_section);

ALTER TABLE production.mos_morlaix_2005_2015_2018_prod2_clean ALTER COLUMN code_insee SET DATA TYPE VARCHAR(255);
ALTER TABLE production.mos_morlaix_2005_2015_2018_prod2_clean ALTER COLUMN subdi_sirs SET DATA TYPE VARCHAR(255);
ALTER TABLE production.mos_morlaix_2005_2015_2018_prod2_clean ALTER COLUMN idu SET DATA TYPE VARCHAR(255);
ALTER TABLE production.mos_morlaix_2005_2015_2018_prod2_clean ALTER COLUMN id_mos SET DATA TYPE VARCHAR(255);
...
FROM production.mos_morlaix_2005_2015_2018_prod2_clean ocs, data_exo.ccca_communes_adeupa com
WHERE com.code_insee = ocs.code_insee
GROUP BY
  ocs.geom,
  ocs.to_milit,
...
SELECT
  ...
  nomenclature15.libelle_n4::character varying(75) as lib4_2012,
  ocs.remarque_2015::character varying(255) as remarque12,
...
ALTER TABLE livrables.livr_mos_morlaix_2005_2015_2018
...
FROM production.mos_pays_brest_2005_2012_2018_prod3 ocs, data_exo.ccca_communes_adeupa com
...
SELECT
  ...
  nomenclature05.libelle_n4::character varying(75) as lib4_2005,
  ocs.remarque_2005::character varying(255) as remarque05,
  ocs.code4_2012::integer,
  nomenclature12.libelle_n4::character varying(75) as lib4_2012,
  ocs.remarque_2012::character varying(255) as remarque12,
  ocs.code4_2018::integer,
  nomenclature18.libelle_n4::character varying(75) as lib4_2018,
  ocs.remarque_2018::character varying(255) as remarque18,
  ST_Area(ocs.geom)::double precision as surface_m2,
...
ALTER TABLE livrables.livr_mos_pays_brest_2005_2012_2018_cc_presquile_crozon
OWNER TO adeupa_user;



DROP TABLE IF EXISTS livrables.livr_cc_pays_de_landerneau_daoulas_2005_2012_2018;

CREATE TABLE  livrables.livr_cc_pays_de_landerneau_daoulas_2005_2012_2018 AS
...
ALTER TABLE livrables.livr_cc_pays_de_landerneau_daoulas_2005_2012_2018
OWNER TO adeupa_user;
...
ALTER TABLE livrables.livr_mos_pays_brest_2005_2012_2018_cc_pays_abers
OWNER TO adeupa_user;
...
ALTER TABLE livrables.livr_mos_pays_brest_2005_2012_2018_cc_pays_iroise
OWNER TO adeupa_user;



DROP TABLE IF EXISTS livrables.livr_cc_communaute_lesneven_2005_2012_2018;

CREATE TABLE  livrables.livr_cc_communaute_lesneven_2005_2012_2018 AS
...
ALTER TABLE livrables.livr_cc_communaute_lesneven_2005_2012_2018
OWNER TO adeupa_user;
...
----- CC HAut-Léon et CC Pays de Landivisiau
DROP TABLE IF EXISTS livrables.livr_cc_haut_leon_cc_pays_landivisiau_2005_2015_2018;

CREATE TABLE  livrables.livr_cc_haut_leon_cc_pays_landivisiau_2005_2015_2018 AS
...
FROM production.mos_haut_leon_2005_2015_2018_prod ocs
GROUP BY
  ocs.geom,
  ocs.to_milit,
  ocs.to_bati,
...
SELECT
  ...
  ocs.to_loisir::integer,
  ocs.to_agri::integer,
  ocs.to_veget::integer as to_veget, 
  ocs.to_eau::integer,
  ocs.to_route::integer,
  ocs.to_batimaison::integer as to_batimai,
  ocs.pre_scol::integer,
...
ALTER TABLE livrables.livr_cc_haut_leon_cc_pays_landivisiau_2005_2015_2018
OWNER TO adeupa_user;
