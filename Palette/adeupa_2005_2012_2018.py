...
def renseignement_multiple(layer):
    ...
    if nF > 1:
        ...
        reply = QMessageBox.question(myDialog, "Message", "Voulez-vous renseigner les " + str(nF) + u" polygones selectionnes pour les dates cochees ?", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
        ...
        for f in selectFeats:
            ...
            if control_rb2012.isChecked() is True:    
                idchampcode4_2012 = layer.fieldNameIndex(nomchamp_code4_2012)
                val_code4_2012 = control_code4_2012.toPlainText()
                layer.changeAttributeValue(feat, idchampcode4_2012, val_code4_2012)
            if control_rb2005.isChecked() is True:    
                idchampcode4_2005 = layer.fieldNameIndex(nomchamp_code4_2005)
                val_code4_2005 = control_code4_2005.toPlainText()
                layer.changeAttributeValue(feat, idchampcode4_2005, val_code4_2005)
