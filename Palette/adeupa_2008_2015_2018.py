...
def ouvrir_formulaire_adeupa(dialog, layer, feature):
    ...
    global nomchamp_code4_2008, nomchamp_code4_2015, nomchamp_code4_2018, nomchamp_subdi_sirs, nomchamp_revise, nomchamp_control
    ...
    global control_code4_2008, control_code4_2015, control_code4_2018, control_subdi_sirs
    global control_surface, control_remarque_2018, control_remarque_2015, control_remarque_2008
    global control_rb2008, control_rb2015, control_rb2018

    


    
    nomchamp_code4_2008 = "code4_2008"
    ...
    nomchamp_remarque_2008 = "remarque_2008"
    ...
    control_code4_2008 = myDialog.findChild(QWidget, nomchamp_code4_2008)
    ...
    control_remarque_2008= myDialog.findChild(QWidget, nomchamp_remarque_2008)
    ...
    control_rb2008 = myDialog.findChild(QWidget, "rb2008")
...
def renseignement_multiple(layer):
    ...
    if nF > 1:
        ...
        # if (nomchamp  == nomchamp_code4_2008r) or (nomchamp  == nomchamp_code_2015e):
        ...
        for f in selectFeats:
            feat = f.id()
            # if control_rb2008.isChecked() is True:
            #     idchampcode4_2008 = layer.fieldNameIndex(nomchamp_code4_2008)
            #     val_code4_2008 = control_code4_2008.toPlainText()
            #     layer.changeAttributeValue(feat, idchampcode4_2008, val_code4_2008)
            ...
            # idchampremarque2008 = layer.fieldNameIndex(nomchamp_remarque_2008)
            # val_remarque2008 = control_remarque_2008.toPlainText()
            # layer.changeAttributeValue(feat, idchampremarque2008, val_remarque2008)
...
def on_buttonx(checked, lst):
    ...
    if control_rb2008.isChecked() is True:
        idx = layer.fieldNameIndex(nomchamp_code4_2008)
        applique_style_gras_et_couleur_rouge_au_texte(control_code4_2008)
        control_code4_2008.setText(control_classe_x.text())

    if control_rb2015.isChecked() is True:
        idx = layer.fieldNameIndex(nomchamp_code4_2015)
        applique_style_gras_et_couleur_rouge_au_texte(control_code4_2015)
        control_code4_2015.setText(control_classe_x.text())
